...
from messaging_abstract.component import Component
from messaging_components.config.config import Config, IQAConfigurationException, Utils
from messaging_components.config.user import User
...
class BrokerConfig(Config):
    ...
    def __init__(self, component: Component, **kwargs):
        super(BrokerConfig, self).__init__(component, **kwargs)
...
class ArtemisConfig(BrokerConfig):
